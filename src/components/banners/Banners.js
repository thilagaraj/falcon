...
const Banner2 = () => {
  return (
    <BannerWrapper>
      <Cards className="mb-70" bodyStyle={{ background: '#C93C3E', borderRadius: '10px', minHeight: '270px' }} headless>
        <Figure2>
...
const Banner3 = () => {
  return (
    <BannerWrapper>
      <Cards  bodyStyle={{ borderRadius: '10px', minHeight: '270px', background: '#C93C3E' }} headless>
        <Figure3>
